...
public enum Messages
{
    ...
    InteractionPermission("use buttons, levers, and switches"),
    AccessPermission("open doors and use beds"),
    ...
    NameClaimPrompt("Type a name for this claim in chat, or type \"skip\" to leave it unnamed."),
    NameClaimConfirmation("Named this claim \"{0}\".", "0: the chosen claim name"),
    NameClaimSkipped("Left this claim unnamed."),
    ...
    NoAccessPermission("You don't have {0}'s permission to use that.", "0: owner name.  access permission controls doors, gates, and beds"),
    NoInteractionPermission("You don't have {0}'s permission to use that.", "0: owner name.  interaction permission controls buttons, levers, and switches"),
